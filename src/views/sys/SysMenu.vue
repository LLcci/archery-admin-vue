  ...
  menuType: {
    editForm: {
      ...
      component: h(
        ...
        {
          default: () => [
            h(ElRadio, { value: 0 }, { default: () => '一级菜单' }),
            h(ElRadio, { value: 1 }, { default: () => '子菜单' }),
            h(ElRadio, { value: 2 }, { default: () => '权限' }),
            h(ElRadio, { value: 3 }, { default: () => '外部链接' })
          ]
        }
      ),
  ...
  openType: {
    editForm: {
      ...
      component: h(
        ...
        {
          default: () => [
            h(ElRadio, { value: 0 }, { default: () => '内部打开' }),
            h(ElRadio, { value: 1 }, { default: () => '外部打开' })
          ]
        }
      ),
      vIf(value) {
