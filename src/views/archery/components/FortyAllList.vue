...
onMounted(async () => {
  ...
  const oneTextPos = getTextPos(ringMap.get('1')!, boxWidth.value, boxWidth.value, 15, 15)
  ...
  const twoTextPos = getTextPos(ringMap.get('2')!, boxWidth.value, boxWidth.value, 15, 15)
  ...
  const threeTextPos = getTextPos(ringMap.get('3')!, boxWidth.value, boxWidth.value, 15, 15)
  ...
  const fourTextPos = getTextPos(ringMap.get('4')!, boxWidth.value, boxWidth.value, 15, 15)
  ...
  const fiveTextPos = getTextPos(ringMap.get('5')!, boxWidth.value, boxWidth.value, 15, 15)
  ...
  const tenTextPos = getTextPos(ringMap.get('10')!, boxWidth.value, boxWidth.value, 8, 5)
