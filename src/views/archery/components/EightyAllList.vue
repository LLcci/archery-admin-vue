...
onMounted(async () => {
  ...
  const oneTextPos = getTextPos(ringMap.get('1')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const twoTextPos = getTextPos(ringMap.get('2')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const threeTextPos = getTextPos(ringMap.get('3')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const fourTextPos = getTextPos(ringMap.get('4')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const fiveTextPos = getTextPos(ringMap.get('5')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const sixTextPos = getTextPos(ringMap.get('6')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const sevenTextPos = getTextPos(ringMap.get('7')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const eightTextPos = getTextPos(ringMap.get('8')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const nineTextPos = getTextPos(ringMap.get('9')!, boxWidth.value, boxWidth.value, 25, 25)
  ...
  const tenTextPos = getTextPos(ringMap.get('10')!, boxWidth.value, boxWidth.value, 20, 15)
